...
if __name__ == '__main__':
    ...
    #
    train_data = load_data(file='train_100k_withratings_new.csv')
    print(train_data)
    ...
    #
    # pred = predict_ratings(test_data=test, item_sim_matrix=item_sim_matrix,
    #                        user_average_rating_vector=user_average_rating_vector)
